...
public class ApplicationContext extends AbstractBean {
	...
	public final ApplicationActionMap getActionMap(Object actionsObject) {
		if (actionsObject == null)
			throw new IllegalArgumentException("actionsObject is null");
		else if (actionsObject instanceof Application)
			return getActionManager().getActionMap(actionsObject.getClass(), actionsObject);
		else
			throw new IllegalArgumentException("Expected type Application, but received " + actionsObject.getClass());
	}
