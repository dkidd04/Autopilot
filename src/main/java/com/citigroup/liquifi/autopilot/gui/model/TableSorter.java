...
public class TableSorter extends AbstractTableModel {
    ...
    public static final Comparator<Object> DOUBLE_COMAPRATOR = new Comparator<Object>() {
        @SuppressWarnings("unchecked")
		public int compare(Object o1, Object o2) {
    ...
    public static final Comparator<Object> INTEGER_COMAPRATOR = new Comparator<Object>() {
        @SuppressWarnings("unchecked")
		public int compare(Object o1, Object o2) {
    ...
    protected Comparator<Object> getComparator(int column){
        ...
        if( columnName.equalsIgnoreCase("Price") ||columnName.equalsIgnoreCase("CumulativeQty") || columnName.equalsIgnoreCase("OrderQty")|| columnName.equalsIgnoreCase("LeavesQty") || columnName.equalsIgnoreCase("TotalLockedInExecQty") )
        	return DOUBLE_COMAPRATOR;
       if(columnName.equalsIgnoreCase("SrcSystemID"))
    	   return INTEGER_COMAPRATOR;
